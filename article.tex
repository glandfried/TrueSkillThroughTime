...
\en{This work enables the incorporation into the temporal causal model implemented of the the extensions developed over the years for the TrueSkill and Item-Response Theory models.}
...
%
\en{For example, it can be used as observable not only the lose/tie/win results, but to evaluate the difference of obtained results~\cite{guo2012-scoreBasedTrueSkill}.}
...
%
\en{Another example is to use causal models that indicate how socio-cultural variables affect individual abilities \cite{VanDerLinden2016}.}
\es{Otra ejemplo es usar un modelo causal que indique como las varables socio-cultural afectan la habilidad individual \cite{VanDerLinden2016}.}
%
