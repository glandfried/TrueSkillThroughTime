...
For this example  we want to show how trueskill can be used with a data set. For this we will use de as input Table \ref{tab:csvExample2}. Its important to de Result input as shown. In this case we will use the library Pandas, but it can be done with out it, the only important its how to upload the data set and loop with it.
