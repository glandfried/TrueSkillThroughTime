...
\begin{figure}[h!]
  ...
  %
  \en{Having $k$ teams, due to the transitivity of the result, it is enough to evaluate $k-1$ differences $d_i$.}
  \es{Teniendo $k$ equipos, gracias a la transitividad de los resultados, es suficiente evaluar $k-1$ distirbuciones de diferencias $d_i$.}
  }
  \label{fig:factorGraph_trueskill}
\end{figure}
%
\en{In this section we will see how to find the best approximate posterior in cases where we have more than two teams.}
\es{En esta sección veremos como encontrar el mejor posterior aproximado en casos en los que tenemos más de dos equipos.}
%
