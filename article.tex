...
%
\en{An example is to use as observable not only the lose/tie/win results, but to use the point difference of those results \cite{guo2012-scoreBasedTrueSkill}.}
