...
%
\en{The field revitalized $20$ years later by the publications of~\cite{bradley1952-pairedComparisions} and~\cite{Mosteller1951a,Mosteller1951b,Mosteller1951c}.}
\es{El campo revitaliz\'o 20 a\~nos despu\'es gracias a las publicaciones de \cite{bradley1952-pairedComparisions} y~\cite{Mosteller1951a,Mosteller1951b,Mosteller1951c}.}
...
%
\en{Since the shape of the exact posterior is similar to a Gaussian, Using a Gaussian to represent the posterior does not seem a bad approximation and instead would allow us to make successive estimates avoiding the computational cost of the sampling methodologies.}
\es{Dado que la forma del posterior exacto se parece a una Gaussiana, usar una Gaussiana para representar el posterior no parece una mala aproximación y en cambio nos permitiría realizar estimaciones sucesivas evitando el costo computacional de la metodolog\'ias de sampleo.}
%
...
%
\begin{equation} \tag{\text{Variational solution}}
 \widehat{p}(s_i| r_{ij}, s_j) = \underset{\widehat{\mu}, \widehat{\sigma}}{\text{ arg max }}  \N(s_i|\widehat{\mu}_i, \widehat{\sigma}_i^2)
\end{equation}
%
