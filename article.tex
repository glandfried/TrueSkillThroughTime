...
% 
\en{A proprotional posterior distribution is obtained by the product of the prior and the likelihood.}
...
\textbf{Ahora, como extendemos la inferencia?}
%
\en{}
\es{}
%
The simplest approach to modelling a sequence of observations is to treat them as independent, corresponding to a set of graph without links between them.
%
\begin{figure}[h!]
  \centering
  \scalebox{.9}{
...
\textbf{En este approach generalemnte se usa el posterior con el prior}.
%
Sin embargo, como la habilidad de las personas cambia en el tiempo, se le agrega algo de incertidumbre.
%
\begin{equation}
 \text{Prior\es{i}}_i^t + \N(0,\gamma^2)= \text{Posterior\es{i}}_i^{t-1}
\end{equation}
%
...
%
\todo[inline, color=gray!50]{Expectation propagation}
