...
\todo[inline]{Me gustaria un parrafo inicial que de la importancia de saber estimar el skill y porque es importante el skill en todo caso}
...
\todo[inline]{El siguiente parrafo presentaria uno de las tecnicas mas conocidas para estimar habilidad: ELO}
...
\todo[inline]{Luego viene comparaci\'on entre ELO y TrueSkill}

\todo[inline]{Lo que seguir\'ia es decir las limitaciones de trueskill y como TTT lo mejora}
...
\todo[inline]{Al final pondriamos otros trabajos relacionados}
