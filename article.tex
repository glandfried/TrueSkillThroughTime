...
%
\en{Our \proglang{Python} package is 10 times faster than the basic \pkg{trueskill}~$0.4.5$ package~\cite{lee-trueskill}.}
...
\begin{table}[H] \centering
    \begin{tabular}{ccc} 
        ...
        \proglang{R} $3.4.4$        & \SI{37.1}{\ms}    & $0.04$X \\ \hline
...
\begin{table}[H] \centering
    \begin{tabular}{ccc} 
        ...
        \hline
        \proglang{R} $3.4.4$        & \SI{360.4}{\ms}   & $0.007$X \\ 
        \hline
...
\begin{table}[H] \centering
    \begin{tabular}{ccc} 
        ...
        \proglang{R} $3.4.4$        & \SI{252.9}{\ms}   & \SI{283.6}{\ms} \\ 
        \hline
...
\begin{table}[H] \centering
    \begin{tabular}{rrr} 
        ...
        \proglang{R} $3.4.4$        & \SI{93000}{\ms} & \SI{149000}{\ms} \\ 
        \hline
