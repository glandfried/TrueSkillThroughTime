...
\title{Harnessing the skill estimation using Bayesian Inference: the \proglang{Julia}, \proglang{Python} and \proglang{R} packages}
\Plaintitle{Harnessing the skill estimation using Bayesian Inference: the Julia, Python and R packages}
...
%
\en{The \ref{eq:sum_rule} states that any marginal distribution can be obtained by integrating, or summing up, the joint probability:}
