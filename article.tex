...
%
\en{To compute it we need to converge history using the method \texttt{convergence()}.}
\es{Para computarlo necesitamos converger la historia usando el método \texttt{convergence()}.}
%
