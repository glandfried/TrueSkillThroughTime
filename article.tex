...
%
%\en{En la sección~\ref{sec:sumProductAlgorithm} introduciremos el \emph{sum-product algorithm}, una algoritmo que permite computar de forma efficiente distribuciones de probabilidad marginal a partir de distribuciones de probabilidad conjunta.}
% %
...
\end{equation}
%
\en{En la figura~\ref{fig:factor_graph} mostramos gráficamente la factorización.}
%
\en{A este tipo de representaciones se las conoce como \emph{factor graph}.}
%
