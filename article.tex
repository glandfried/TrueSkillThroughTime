...
%
\en{For example, in sports development and education, knowing the skill and how it changes can support avoiding exposing agents to imbalanced challenges, maintaining the interest and engagement, and monitoring the learning and improvement process.}
...
%
\en{The naive solution (i.e. frequency of positive results) is not a good estimator because it depends on the difficulty of the challenges.}
