...
%
\begin{lstlisting}[backgroundcolor=\color{julia},caption={\en{\prolang{Julia} code}\es{}},aboveskip=0.0 \baselineskip, belowskip=0.1cm]
...
\end{lstlisting}
%
\begin{lstlisting}[backgroundcolor=\color{r},caption={\en{\prolang{R} code}\es{}},aboveskip=0.0 \baselineskip, belowskip=0.1cm]
N = 1000
