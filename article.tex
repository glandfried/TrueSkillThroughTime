...
\subsection{\en{Information propagation in the class History}\es{Propagación de la información en la clase History}} \label{sec:throguthTime}
...
%
\begin{align*}
\emph{forwardPrior}(s_t) &= \N(s_t\,|\,\emph{forwardPosterior}(s_{t-1}), \gamma^2) \ \ \ \ \ \ \\ \emph{backwardPrior}(s_t) &= \N(s_t\,|\,\emph{backwardPosterior}(s_{t+1}), \gamma^2)
\end{align*}
%
