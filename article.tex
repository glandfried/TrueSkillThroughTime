...
%
\en{However they are hidden variable, so in practice the best we can do is estimate it from its direct observable consequences: the outcome of problem solving and competitions.}
