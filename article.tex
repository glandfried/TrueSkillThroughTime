...
\en{The parameter $\beta^2$, being the same for all the agents, acts as the scale of the estimations: skills separated by a $\beta$ keep always the same probability of winning.}
...
%
\en{The prior quantifies the uncertainty about the ability, and the posterior contains the uncertainty that remains after seeing the new data (the result of the event).}
\es{El prior cuantifica la incertidumbre sobre la habilidad, y el posterior contiene la incertidumbre que queda luego de ver el nuevo dato (el resultado del evento).}
%
