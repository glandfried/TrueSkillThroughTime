...
FIGURA:
%
Comportamiento de las estimaciones de habilidad utilizando el TrueSkill Through Time, basado en el enfoque \emph{smoothing}, y TrueSkill, basado en el enfoque \emph{filtering}.
%
