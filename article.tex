...
\todo[inline]{M\'as de venta de la importancia, inter\'es y potencial uso de saber la habilidad de alguien}
%
...
%
\en{Since the first generative models, proposed almost a century ago by~\cite{thurstone1927-comparativeJugement} and~\cite{zermelo1929-translation}, it is assumed that the probability of observing a positive result depends on the \emph{difference in strength} between the agent and their target, $p(\,r=1 \,|\, d_{ij}\,)$.}
\es{Ya los primeros modelos generativos, propuestos hace casi un siglo por~\cite{thurstone1927-comparativeJugement} y~\cite{zermelo1929-translation}, suponen que la probabilidad de observar un resultado positivo depende de la \emph{diferencia de escala} entre el agente y su objetivo, $p(\,r=1 \,|\, d_{ij}\,)$.}
