...
\begin{table}[H] \centering
    \begin{tabular}{ccc} 
        ...
        \proglang{R} $3.4.4$        & \SI{10.4}{\ms}    & $0.14$X \\ \hline
...
\begin{table}[H] \centering
    \begin{tabular}{ccc} 
        ...
        \hline
        \proglang{R} $3.4.4$        & \SI{124.9}{\ms}   & $0.02$X \\ 
        \hline
...
\begin{table}[H] \centering
    \begin{tabular}{ccc} 
        ...
        \proglang{R} $3.4.4$        & \SI{110.3}{\ms}   & \SI{111.4}{\ms} \\ 
        \hline
...
\begin{table}[H] \centering
    \begin{tabular}{rrr} 
        ...
        \proglang{R} $3.4.4$        & \SI{43000}{\ms} & \SI{55000}{\ms} \\ 
        \hline
