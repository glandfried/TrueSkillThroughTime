...
\es{La ventaja de este modelo reside en la aplicación estricta la teoría de la probabilidad: todos los supuestos se hacen expl\'icitos a trav\'es de un modelo generativo, y la inferencia se resuelve sólo con las regla de la probabilidad, nada más que las reglas de la suma y el producto.}
%
...
%
\en{Given $\widehat{p}(d)$, we can compute the approximate ascending message using the operations ot the class \texttt{Gaussian}.}
