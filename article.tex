...
%
\begin{equation}\label{eq:p*_d} \tag{\texttt{trunc}}
...
\begin{lstlisting}[backgroundcolor=\color{julia}]
tie = false
pd_ = trunc(diff,margin,tie)
\end{lstlisting}
\switchcolumn
\begin{lstlisting}[backgroundcolor=\color{python}]
tie = False
pd_ = trunc(d,v,margin,tie)
\end{lstlisting}
\switchcolumn
\begin{lstlisting}[backgroundcolor=\color{r}]
tie = F
...
%
\begin{equation}\label{eq:m^_d_fd} \tag{\texttt{approx\_message}}
\begin{split}
...
\tikz{ %        
        ...
        \path[draw, -latex, fill=black!50,sloped] (d1) edge[bend left,draw=black!50] node[midway,above,color=black!75] {\scriptsize \ \ $\widehat{\text{\emph{likelihood}}}(d_0)$} (fd1);
        
        \path[draw, -latex, fill=black!50,sloped] (fd1) edge[bend left,draw=black!50] node[midway,above,color=black!75] {\scriptsize \emph{prior}$(d_{0})$} (d1);
        
        \path[draw, -latex, fill=black!50,sloped] (tc) edge[bend left,draw=black!50] node[midway,above,color=black!75] {\scriptsize\emph{likelihood}$(t_2)$} (ftc);
...
%
\begin{lstlisting}[backgroundcolor=\color{all}]
prior_a = performance(team_a); prior_b = performance(team_b); prior_c = performance(team_c)
lose_likelihood_1 = Ninf; win_likelihood_2 = Ninf
\end{lstlisting}
%
\begin{equation}
 \begin{split}
  \emph{losePosterior}(t_{i}) = \emph{prior}(t_i) \cdot \emph{winLikelihood}(t_i)
 \end{split}
\end{equation}
%
\begin{lstlisting}[backgroundcolor=\color{all}]
lose_posterior_tb = prior_tb * win_likelihood_tb
\end{lstlisting}
%
\begin{equation}
 \begin{split}
...
%
\begin{lstlisting}[backgroundcolor=\color{all}]
prior_d1 = prior_ta * lose_posterior_tb
\end{lstlisting}
%
\begin{equation}
\begin{split}
...
%
\begin{lstlisting}[backgroundcolor=\color{all}]
lose_posterior_1 = prior_c * win_likelihood_1
\end{lstlisting}
%
\begin{equation}
\begin{split}
