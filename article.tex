...
\end{equation}
%
\en{Where $y_{ij}$ is $1$ for winners and $-1$ for losers, and the probability of the observed result given the old estimates can be derived from Figure~\ref{fig:generative_model} (details at section~\ref{sec:exactSolution}).}
