...
\end{lstlisting}
%
\en{The evidence is $0.5$, indicating that the a priori probability of the observed result was the same for both teams.}
...
The first examples is the most basic one we figure out.
Its one of the first examples in the official python package of \texttt{Trueskill}.
