...
\caption{
 \en{Game with 3 teams.}
 \es{Partida con 3 equipos.}
 %
 \en{The names will be used to explain the inference procedure.}
 \es{Los nombres se usarán para explicar el procedimiento de actualización.}
}
\label{fig:ep_ts}
\end{figure}
%
...
\end{lstlisting}
%
\en{We compute the margins from the draw probability and the number of players in each comparison, $d_i$.}
\es{Calculamos el los margenes a partir de la probabilidad de empate y la cantidad de jugadores en cada comparación $d_1$.}
%
\begin{lstlisting}[backgroundcolor=\color{all}]
