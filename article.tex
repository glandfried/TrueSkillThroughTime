...
% sacar linea en blanco, y sacar la linea entre el import y lo otro
...
\end{lstlisting}
% explicar la info que sale del resutlado
% no es la varianza es el desvio
% contar la expresion de result
%explicar que es Rating, draw prob 0
...
% repetir los de que es mas comodo por estar en una linea
% sacar batch number
...
% sacar como es TTT yaque se comento antes. poder poner como ya se menciono....
\lstinputlisting{./code/Example3.py}

% aclarar que no hay implementacion de esto, y por que es mejor.
