...
%
\en{For reference, our \proglang{Python} package is 10 times faster than the basic \pkg{trueskill}~$0.4.5$ package~\cite{lee-trueskill}.}
\es{Como referencia, nuestro paquete de \proglang{Python} es 10 veces más rápido que el paquete básico \pkg{trueskill}~$0.4.5$ \cite{lee-trueskill}.}
%
...
%
\en{The total runtimes for initialization of the \texttt{History} class and the \texttt{convergence()} method were,}
