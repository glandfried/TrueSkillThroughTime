...
%
\en{The model assumes that the agent with the highest performance wins, $r = (p_i > p_j)$, which may vary through the different events around the true skill with some constant noise.
In the case of agent $i$, the model states: $\N(p_i\,|\,s_i,\beta^2)$.}
\todo[inline]{Que pasa con el beta, no se dice nada de nada?}
...
\todo[inline]{La frase acerca de la representaci\'on gr\'afica no se entiende, no tiene contexto ni justificaci\'on, la coment\'e, pero yo la borrar\'ia directamente.}
% Parrafo
