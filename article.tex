...
%
\en{Its graphical representation defines a joint distribution, from which it is possible to derive, among others, the prediction of the result given the previous estimates, $P(\,r\,|\,s_{i_\text{old}},s_{j_\text{old}}\,)$.}
\es{Su representaci\'on gr\'afica define una distribuci\'on conjunta, a partir de la cual se puede derivar entre otras, la predicción del resultado dadas las estimaciones previas, $P(\,r\,|\,s_{i_\text{old}},s_{j_\text{old}}\,)$.}
...
\es{Y toda inferencia se hace aplicando las reglas de la probabilidad, de la suma y del producto, sobre el modelo representado como una distribución conjunta.}
