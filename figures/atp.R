...
polygon(c(as.Date(data$connors_time, origin=origin)[filtro],rev(as.Date(data$connors_time, origin=origin)[filtro])), c(data$connors_mu[filtro]+data$connors_sigma[filtro],rev(data$connors_mu[filtro]-data$connors_sigma[filtro])),  col=rgb(0.2,0.2,0.5,0.1), border=F )
...
polygon(c(as.Date(data$borg_time, origin=origin)[filtro],rev(as.Date(data$borg_time, origin=origin)[filtro])), c(data$borg_mu[filtro]+data$borg_sigma[filtro],rev(data$borg_mu[filtro]-data$borg_sigma[filtro])), col=rgb(0.5,0.2,0.2,0.1), border=F )
...
polygon(c(as.Date(data$mcenroe_time, origin=origin)[filtro],rev(as.Date(data$mcenroe_time, origin=origin)[filtro])), c(data$mcenroe_mu[filtro]+data$mcenroe_sigma[filtro],rev(data$mcenroe_mu[filtro]-data$mcenroe_sigma[filtro])), col=rgb(0.2,0.5,0.2,0.1), border=F )
...
polygon(c(as.Date(data$lendl_time, origin=origin)[filtro],rev(as.Date(data$lendl_time, origin=origin)[filtro])), c(data$lendl_mu[filtro]+data$lendl_sigma[filtro],rev(data$lendl_mu[filtro]-data$lendl_sigma[filtro])), col=rgb(0.8,0,0.8,0.1), border=F )
# 
...
polygon(c(as.Date(data$edberg_time, origin=origin)[filtro],rev(as.Date(data$edberg_time, origin=origin)[filtro])), c(data$edberg_mu[filtro]+data$edberg_sigma[filtro],rev(data$edberg_mu[filtro]-data$edberg_sigma[filtro])),  col=rgb(0,0.7,0.7,0.1), border=F )
...
polygon(c(as.Date(data$aggasi_time, origin=origin)[filtro],rev(as.Date(data$aggasi_time, origin=origin)[filtro])), c(data$aggasi_mu[filtro]+data$aggasi_sigma[filtro],rev(data$aggasi_mu[filtro]-data$aggasi_sigma[filtro])), col=rgb(0.3,0.3,0.3,0.1), border=F )
filtro = !is.na(data$mcenroe_time)

filtro=!is.na(data$sampras_mu-data$sampras_sigma)
polygon(c(as.Date(data[,"sampras_time"], origin=origin)[filtro],rev(as.Date(data[,"sampras_time"], origin=origin)[filtro])), c(data$sampras_mu[filtro]+data$sampras_sigma[filtro],rev(data$sampras_mu[filtro]-data$sampras_sigma[filtro])), col=rgb(0.8,0.8,0,0.1), border=F )
...
polygon(c(as.Date(data[,"federer_time"][filtro], origin=origin),rev(as.Date(data[,"federer_time"][filtro], origin=origin))), c(data$federer_mu[filtro]+data$federer_sigma[filtro],rev(data$federer_mu[filtro]-data$federer_sigma[filtro])), col=rgb(0,0,0.8,0.1), border=F )


lines(as.Date(data[,"nadal_time"], origin=origin),data$nadal_mu, col=nadal, lwd=2)
filtro=!is.na(data$nadal_mu-data$nadal_sigma)
polygon(c(as.Date(data[,"nadal_time"], origin=origin)[filtro],rev(as.Date(data[,"nadal_time"], origin=origin)[filtro])), c(data$nadal_mu[filtro]+data$nadal_sigma[filtro],rev(data$nadal_mu[filtro]-data$nadal_sigma[filtro])), col=rgb(0,0.8,0,0.1), border=F )
...
polygon(c(as.Date(data[,"djokovic_time"], origin=origin)[filtro],rev(as.Date(data[,"djokovic_time"], origin=origin)[filtro])), c(data$djokovic_mu[filtro]+data$djokovic_sigma[filtro],rev(data$djokovic_mu[filtro]-data$djokovic_sigma[filtro])), col=rgb(0.5,0.2,0.2,0.1), border=F )
