...
plot(s,dnorm(s, data$p_a_1_mu[n], data$p_a_1_sigma[n]),type="l"
     ,ylim=c(0,max(dnorm(s, data$p_a_2_mu[n], data$p_a_2_sigma[n]))),axes = F, ann = F)
axis(side=1, labels=NA,cex.axis=0.6,tck=0.015, line=0)
axis(lwd=0,side=1, at=0,cex.axis=3,line=0.6,tck=0.015)
for (i in seq(1,n-1)){
  lines(s,dnorm(s, data$p_a_1_mu[i], data$p_a_1_sigma[i])) 
}
abline(v=0, lty=3)
# within
...
axis(lwd=0,side=1, at=0,cex.axis=3,line=0.6,tck=0.015)
for (i in seq(1,n-1)){
  lines(s,dnorm(s, data$wp_a_1_mu[i], data$wp_a_1_sigma[i])) 
}
abline(v=0, lty=3)
# Likelihood approx
...
axis(lwd=0,side=1, at=0,cex.axis=3,line=0.6,tck=0.015)
for (i in seq(1,n-1)){
  lines(s,dnorm(s, data$lh_a_1_mu[i], data$lh_a_1_sigma[i])) 
}
abline(v=0, lty=3)
# A2
# Post
...
axis(lwd=0,side=1, at=0,cex.axis=3,line=0.6,tck=0.015)
for (i in seq(1,n-1)){
  lines(s,dnorm(s, data$p_a_2_mu[i], data$p_a_2_sigma[i])) 
}
abline(v=0,lty=3)
# within
...
axis(lwd=0,side=1, at=0,cex.axis=3,line=0.6,tck=0.015)
for (i in seq(1,n-1)){
  lines(s,dnorm(s, data$wp_a_2_mu[i], data$wp_a_2_sigma[i])) 
}
abline(v=0, lty=3)
# Likelihood approx
...
axis(lwd=0,side=1, at=0,cex.axis=3,line=0.6,tck=0.015)
for (i in seq(1,n-1)){
  lines(s,dnorm(s, data$lh_a_2_mu[i], data$lh_a_2_sigma[i])) 
}
abline(v=0, lty=3)
# B1
# Post
...
axis(lwd=0,side=1, at=0,cex.axis=3,line=0.6,tck=0.015)
for (i in seq(1,n-1)){
  lines(s,dnorm(s, data$p_b_1_mu[i], data$p_b_1_sigma[i])) 
}
abline(v=0, lty=3)
# within
...
axis(lwd=0,side=1, at=0,cex.axis=3,line=0.6,tck=0.015)
for (i in seq(1,n-1)){
  lines(s,dnorm(s, data$wp_b_1_mu[i], data$wp_b_1_sigma[i])) 
}
abline(v=0, lty=3)
# Likelihood approx
...
axis(lwd=0,side=1, at=0,cex.axis=3,line=0.6,tck=0.015)
for (i in seq(1,n-1)){
  lines(s,dnorm(s, data$lh_b_1_mu[i], data$lh_b_1_sigma[i])) 
}
abline(v=0, lty=3)
# B2
# Post
...
axis(lwd=0,side=1, at=0,cex.axis=3,line=0.6,tck=0.015)
for (i in seq(1,n-1)){
  lines(s,dnorm(s, data$p_b_2_mu[i], data$p_b_2_sigma[i])) 
}
abline(v=0, lty=3)
# within
...
axis(lwd=0,side=1, at=0,cex.axis=3,line=0.6,tck=0.015)
for (i in seq(1,n-1)){
  lines(s,dnorm(s, data$wp_b_2_mu[i], data$wp_b_2_sigma[i])) 
}
abline(v=0, lty=3)
# Likelihood approx
...
axis(lwd=0,side=1, at=0,cex.axis=3,line=0.6,tck=0.015)
for (i in seq(1,n-1)){
  lines(s,dnorm(s, data$lh_b_2_mu[i], data$lh_b_2_sigma[i])) 
}
abline(v=0, lty=3)
# Prior
