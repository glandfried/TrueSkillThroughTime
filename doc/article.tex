...
%
\en{Someone might suspect that the expressions \ref{eq:log_evidence_online} and \ref{eq:log_evidence_online} are unreliable because they might indirectly use information from the future to correctly predict the result of events.}
\es{Alguien podría sospechar que las expresiones \ref{eq:log_evidence_online} y \ref{eq:log_evidence_online} no son confiables porque podrían usar indirectamente información del futuro para predecir correctamente el resultado de los eventos.}
%
...
%
\en{This example illustrate that the \ref{eq:log_evidence_online} and \ref{eq:log_evidence_online} expressions do not use information about the future indirectly to artificially improve their predictions.}
\es{Este ejemplo ilustra que las expresiones \ref{eq:log_evidence_online} y \ref{eq:log_evidence_online} no usan la información del futuro de manera indirecta para artificialmente mejorar sus predicciones.}
%
...
\section{Summary and discussion} \label{sec:summary}
 ...
 \en{Estimating how individual skills evolves through time is essential in the educational system or in the labor market.}
 ...
 %
 \en{Although this improvement was published more than a decade ago, it had not been implemented until in the programming languages noted for having the largest scientific software development communities.}
...
%
\en{This work is supported by Universidad de Buenos Aires and CONICET}
\es{Este trabajo fue apoyado por la Universidad de Buenos Aires y CONICET.}
