...
\begin{figure}[ht!]
    ...
    \caption{
    \en{Difference between the exact solution $ P (D | M) $ and TrueSkill, the approximate solutions ({\small$\widehat{\text{LOOCV}}$}), and $ \widehat{P}(D | M) $ as we add more events to the example presented in the introduction (Fig.~\ref{fig:smooth_example}). }%
